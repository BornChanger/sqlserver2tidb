...
- Export/import state phase fields are optional during initialization, but must match `export` and `import` when present; their optional `updated_at` fields must be RFC3339.
